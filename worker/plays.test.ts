...

{
  ...
  // Both are keyed by seat (0 | 1), not player id — solo mode puts the same
  // player id in both `seats`.
  const gravity = (phase: 'running' | 'done', winner: 0 | 1 | null): ServerMessage => ({
    t: 'gravity',
    s: 1,
    d: {
