...
cows' embeds crops of its own `barn.png`/`cow.png` (the UFO, its cone, the
stars and the ground stay fresh vector paths around them), Random Game's
...
**Four of the six are generated** rather than hand-assembled, all gated by a
