...
| [Asteroid Race](games/asteroid-race.md) | *Dodge the rocks, blast the rest, get there first* | orientation + touch | 1–8 | 📝 draft — awaiting approval ([#24](https://github.com/VincentGuigui/FonyGames/issues/24)) |
