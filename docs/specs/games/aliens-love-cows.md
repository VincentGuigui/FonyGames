...
| **Illustration** | `www/src/games/aliens-love-cows/art/card.svg` — a UFO's light cone over a barn, a cow mid-abduction, the UFO, barn and cow the maintainer's own art (spec §12), generated by `generate-card.mjs` |
| **Players** | 2–8 |
