...
| M5d | **Cat and Mouse** | [Cat and Mouse](specs/games/cat-and-mouse.md) specced. **Not built**: it is the first game needing streamed positions, and §12 has no accessible fallback designed yet — both want a decision before code | 📝 specced, ⏳ awaiting go-ahead |
