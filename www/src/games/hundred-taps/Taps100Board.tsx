...
import { TAPS100_TOTAL, type Player, type PlayerId } from '../../../../shared/protocol';
import { StatusBar } from '../../core/ui/StatusBar';
import { Scoreboard, type ScoreRow } from '../../core/ui/Scoreboard';
import { RulesPanel } from '../../core/ui/RulesPanel';
import { formatClock, elapsedMs, cellColor, TAPS100_ROW_COUNTS, TAPS100_ROW_STARTS, type Taps100Game } from './game';
import { Timeline } from './Timeline';
import { useGameText } from '../../core/i18n/gameText';
import { SoundToggle as SharedSoundToggle } from '../../core/ui/SoundToggle';

/**
 * The board: a hundred numbered circles, six-centred/eight-across/six-centred
 * (spec §4, `TAPS100_ROW_COUNTS`) rather than a square grid. Spec: docs/specs/games/hundred-taps.md §4
 *
...
export function Taps100Board({
  ...
  return (
    <div class="taps100" style={{ '--game-accent': accent } as JSX.CSSProperties}>
      ...
      <div class="taps100__grid-wrap">
        <div class="taps100__grid" role="group" aria-label={text({ en: 'The board', fr: 'Le plateau' })}>
          {TAPS100_ROW_COUNTS.map((rowCount, rowIndex) => {
            const rowStart = TAPS100_ROW_STARTS[rowIndex]!;
            return (
              <div class="taps100__row" key={rowIndex}>
                {Array.from({ length: rowCount }, (_, i) => {
                  const cell = rowStart + i;
                  ...
                  return (
                    <button
                      ...
                      style={{ '--cell-color': cellColor(number ?? 0, TAPS100_TOTAL) } as JSX.CSSProperties}
                      aria-label={
                        isGone
